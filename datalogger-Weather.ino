...
/*
  ...
  //      print_battery_voltage(dataFile); //writes the battery voltage to SD card
...
void print_battery_voltage(File file){
  float measure = analogRead(A5)/1023.0*5;
  float voltage = 4.3 * measure;
